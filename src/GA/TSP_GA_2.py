...
if __name__ == "__main__":
    ...
    plot_scores(history, title="GA run 1", filename="images/realNumber_PolynomialMutation.png")
    plot_tour(coords, best_path, best_cost, title="GA run 1", filename="images/bestTour_realNumber_PolynomialMutation.png")
    ...
    plot_scores(history, title="GA run 1", filename="images/bestTour_realNumber_GaussianMutation.png")
    plot_tour(coords, best_path, best_cost, title="GA run 1", filename="images/realNumber_GaussianMutation.png")